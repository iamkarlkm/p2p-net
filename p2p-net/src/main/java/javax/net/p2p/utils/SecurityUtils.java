...
public class SecurityUtils {
    ...
    public static String md5WithSha256(String inputText) {
        return md5(sha256ToString(inputText));
    }
     ...
     * @return
     */
    public static String sha256ToString(String inputText) {
     ...
     * @return
     */
    public static byte[] sha256(String inputText) {
    ...
    public static String initAesSecretKeyToBase64() {  
        return Base64.encode(initAesSecretKey());
    }  
    ...
    public static byte[] encryptAes(byte[] data,String key) throws Exception{  
        return encryptAes(data, Base64.decode(key));
    }
    ...
    public static byte[] decryptAes(byte[] data,String key) throws Exception{ 
        return decryptAes(data, Base64.decode(key));
    }
    ...
    public static String encryptStringAes(String data,String key) throws Exception{  
        return Base64.encode(encryptAes(data.getBytes(DEFAULT_CHARSET), Base64.decode(key)));
    }
    ...
    public static String decryptStringAes(String data,String key) throws Exception{ 
        return new String(decryptAes(Base64.decode(data), Base64.decode(key)), DEFAULT_CHARSET);
    }
